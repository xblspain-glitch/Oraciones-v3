...
if("serviceWorker" in navigator){window.addEventListener("load",()=>{navigator.serviceWorker.register("sw.js?v=v3-1-222-marca-agua-ajuste-final-cache-limpia",{updateViaCache:"none"})})}
  ...
  try{
    ...
    try{
      const cardBackground=await new Promise((resolve,reject)=>{
        ...
        im.onerror=reject;
        im.src=selectedBackgroundV2219+"?v=v3-1-222-marca-agua-ajuste-final-cache-limpia";
      });
    ...
    await drawExactLogoWatermark(ctx,540,isThematicV2220?1285:1133,isThematicV2220?650:780);
