...
if("serviceWorker" in navigator){window.addEventListener("load",()=>{navigator.serviceWorker.register("sw.js?v=v3-1-231-marca-agua-grande-cache-totalmente-renovada",{updateViaCache:"none"})})}
  ...
  try{
    ...
    try{
      const cardBackground=await new Promise((resolve,reject)=>{
        ...
        im.onerror=reject;
        im.src=selectedBackgroundV2219+"?v=v3-1-231-marca-agua-grande-cache-totalmente-renovada";
      });
    ...
    await drawExactLogoWatermark(ctx,540,isThematicV2220?1230:1133,isThematicV2220?870:780);
